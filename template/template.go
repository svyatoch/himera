...
import (
	...
	errors2 "github.com/svyatoch/himera/modules/errors"
	...
	"github.com/svyatoch/himera/template/login"
...
type Component interface {
	...
	//
	// See:
	// https://github.com/svyatoch/himera/blob/master/template/login/theme1.tmpl#L32
	// https://github.com/svyatoch/himera/blob/master/template/login/list.go
	GetAssetList() []string
