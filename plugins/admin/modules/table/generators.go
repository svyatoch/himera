...
import (
	...
	"github.com/svyatoch/himera/modules/collection"
	"github.com/svyatoch/himera/modules/config"
	"github.com/svyatoch/himera/modules/db"
	"github.com/svyatoch/himera/modules/db/dialect"
	errs "github.com/svyatoch/himera/modules/errors"
	"github.com/svyatoch/himera/modules/language"
	"github.com/svyatoch/himera/modules/logger"
	"github.com/svyatoch/himera/modules/ui"
	"github.com/svyatoch/himera/modules/utils"
	"github.com/svyatoch/himera/plugins/admin/models"
	form2 "github.com/svyatoch/himera/plugins/admin/modules/form"
	"github.com/svyatoch/himera/plugins/admin/modules/parameter"
	"github.com/svyatoch/himera/plugins/admin/modules/tools"
	"github.com/svyatoch/himera/template"
	"github.com/svyatoch/himera/template/types"
	"github.com/svyatoch/himera/template/types/action"
	"github.com/svyatoch/himera/template/types/form"
	selection "github.com/svyatoch/himera/template/types/form/select"
...
func (s *SystemTable) GetGenerateForm(ctx *context.Context) (generateTool Table) {
	...
	formList.AddField(lgWithScore("extra import package", "tool"), "extra_import_package", db.Varchar, form.Select).
		FieldOptions(types.FieldOptions{
			...
			{Text: "log", Value: "log"},
			{Text: "fmt", Value: "fmt"},
			{Text: "github.com/svyatoch/himera/modules/db/dialect", Value: "github.com/svyatoch/himera/modules/db/dialect"},
			{Text: "github.com/svyatoch/himera/modules/db", Value: "github.com/svyatoch/himera/modules/db"},
			{Text: "github.com/svyatoch/himera/modules/language", Value: "github.com/svyatoch/himera/modules/language"},
			{Text: "github.com/svyatoch/himera/modules/logger", Value: "github.com/svyatoch/himera/modules/logger"},
		}).
		FieldDefault("").
